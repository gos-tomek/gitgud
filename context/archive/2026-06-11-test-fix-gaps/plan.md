...
- [x] 7.1 `npm test -- tests/component/CreateBoardForm.test.tsx` passes — 996065f
- [x] 7.2 Zero "Known bug"/"Known defect" comments in file — 996065f
- [x] 7.3 `npm run lint` passes — 996065f

#### Manual

- [x] 7.4 Each bug fix has at least one regression test — 996065f
- [x] 7.5 Test count ≥ original W1-W9 — 996065f

### Phase 8: REVOKE ALL Migration

#### Automated

- [x] 8.1 Migration applies cleanly: `npx supabase db reset` — 3975550
- [x] 8.2 `npm test` passes — all integration tests green — 3975550
- [x] 8.3 Cross-board isolation tests unchanged and passing — 3975550

#### Manual

- [x] 8.4 Verify REVOKE in Supabase Studio privilege list — 3975550
- [x] 8.5 Board creation via UI still succeeds — 3975550
